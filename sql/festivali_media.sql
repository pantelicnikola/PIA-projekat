...
CREATE TABLE `media` (
  ...
  KEY `IdFestivalMedia_idx` (`IdFestival`),
  CONSTRAINT `IdFestivalMedia` FOREIGN KEY (`IdFestival`) REFERENCES `festival` (`IdFestival`) ON DELETE CASCADE ON UPDATE NO ACTION
